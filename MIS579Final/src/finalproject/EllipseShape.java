...
public class EllipseShape extends AbstractShape {
	...
	public void show() {
		...
		majorAxisTextField = new JTextField(INITIAL_FIELD_VALUE, 10);
		...
		minorAxisTextField = new JTextField(INITIAL_FIELD_VALUE, 10);
	...
	public void clear(){
		majorAxisTextField.setText(INITIAL_FIELD_VALUE);
		minorAxisTextField.setText(INITIAL_FIELD_VALUE);
